...
page_id: concepts/local-regression
page_type: concept
related:
...
Estimating an unknown regression function by fitting simple models within local kernel-weighted neighborhoods, trading bias against variance via a bandwidth.
