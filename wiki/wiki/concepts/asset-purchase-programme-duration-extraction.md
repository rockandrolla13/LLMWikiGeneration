...
page_id: concepts/asset-purchase-programme-duration-extraction
page_type: concept
related:
...
The ECB's large-scale asset purchases (PSPP from 2015) calibrated via an inflation-gap approach and operating through 'duration extraction' to compress term premia and lower sovereign and lending yields.
