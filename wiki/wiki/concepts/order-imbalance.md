...
tags: [order-imbalance, etf-flows, order-flow, market-microstructure, limit-order-book]
sources: [sources/petit-2025-data-driven-flow-etf, sources/xu-2020-mlofi, sources/koukorinis-stylized-facts]
related: [concepts/order-flow, concepts/etf-flows, concepts/flow-decomposition, concepts/limit-order-book, concepts/market-microstructure]
