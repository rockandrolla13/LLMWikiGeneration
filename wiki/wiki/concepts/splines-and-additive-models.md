...
page_id: concepts/splines-and-additive-models
page_type: concept
related:
...
Flexible regression built from piecewise-polynomial spline bases and additive structures (GAM) summing smooth functions of individual predictors, balancing flexibility with interpretability.
