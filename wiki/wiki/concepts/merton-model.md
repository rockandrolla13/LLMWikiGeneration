...
A structural credit-risk model (originating with Merton 1974) that specifies a firm-value process and triggers default when firm value falls to a debt-related threshold, pricing equity as a call option and risky debt as a short put on firm value.
