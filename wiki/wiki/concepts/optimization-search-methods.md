...
page_id: concepts/optimization-search-methods
page_type: concept
related:
...
Algorithms for exploring a strategy's parameter space, from grid search and hill climbing to simulated annealing, genetic algorithms, and particle swarm.
