...
An evaluation method that sets an indicator threshold and scores it against a policy-maker loss function trading off Type I (missed crises) versus Type II (false alarms) errors.
