...
page_id: concepts/bank-capital-structure-seniority
page_type: concept
related:
...
The hierarchy of bank liabilities (Tier 2, non-preferred senior, preferred senior) whose relative spreads and loss-given-failure drive relative-value trades.
