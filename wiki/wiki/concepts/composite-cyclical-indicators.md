...
page_id: concepts/composite-cyclical-indicators
page_type: concept
related:
...
Leading, coincidence, and lagging composite indices that summarize business-cycle timing; the lagging index proved the best financial-performance predictor.
