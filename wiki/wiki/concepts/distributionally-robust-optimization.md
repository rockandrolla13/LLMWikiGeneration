...
tags: [distributionally-robust-optimization, robustness, conformal-prediction, fairness, distribution-shift]
sources: [sources/yang-2026-multi-distribution-robust-cp]
related: [concepts/worst-case-coverage, concepts/multi-distribution-robust-cp, concepts/conformal-prediction, concepts/max-p-aggregation, concepts/conditional-validity]
