...
page_id: concepts/half-life-of-adjustment
page_type: concept
related:
...
The time for half of a shock's effect to dissipate, computed from the error-correction coefficient; used as a proxy for the post-crisis recovery period.
