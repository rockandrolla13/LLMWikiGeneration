...
page_id: concepts/ladder-of-causation
page_type: concept
related:
...
Pearl's three-rung hierarchy of causal reasoning - association (seeing), intervention (doing), and counterfactuals (imagining) - where each rung requires capabilities and information unavailable at the rung below.
