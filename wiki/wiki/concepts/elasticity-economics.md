...
A dimensionless measure of the responsiveness of one economic quantity to changes in another, defined via derivatives; includes own-price, partial, and cross elasticity.
