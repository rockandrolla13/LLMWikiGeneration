...
page_id: concepts/trading-strategy-overfitting
page_type: concept
related:
...
Tailoring a strategy's rules and parameters so closely to historical data that it captures noise rather than persistent structure, producing strong backtests that fail out-of-sample.
