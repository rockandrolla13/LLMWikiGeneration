...
page_id: concepts/bayesian-updating
page_type: concept
related:
...
Combining an initial belief (prior) with recent objective data via Bayes' Theorem to produce a revised belief; the practical emphasis is gradual updating in proportion to the weight of evidence.
