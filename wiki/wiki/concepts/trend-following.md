...
page_id: concepts/trend-following
page_type: concept
related:
...
A directional strategy that identifies persistent price trends (via moving-average-style rules of varying speed) and bets they continue, long uptrends and short downtrends across many instruments.
