...
page_id: concepts/global-growth-differentials
page_type: concept
related:
...
Relative growth rates between regions (e.g. developed versus emerging markets) that drive cross-asset and currency allocation.
