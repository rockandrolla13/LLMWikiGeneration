...
- Arup Kumar Sadhu (first author; PhD Jadavpur University 2017; scientist at Tata Consultancy Services)
- Amit Konar (second author; Jadavpur University)
- Jadavpur University, Kolkata, India — Artificial Intelligence Laboratory and Control Engineering Laboratory, Dept. of Electronics and Telecommunication Engineering
- Tata Consultancy Services (TCS) — Research & Innovation Labs
- Wiley-IEEE Press / John Wiley & Sons, Inc. (publisher)
- IEEE Press — Editorial Board: Ekram Hossain (Editor in Chief), Jón Atli Benediktsson, David Alan Grier, Elya B. Joffe, Xiaoou Li, Peter Lian, Andreas Molisch, Saeid Nahavandi, Jeffrey Reed, Diomidis Spinellis, Sarah Spurgeon, Ahmet Murat Tekalp
- Claus and Boutilier (independent learner / joint action learner framework)
- Littman (Team Q-learning; Minimax Q-learning; Friend-or-Foe Q-Learning)
- Hu and Wellman (Nash Q-learning for general-sum stochastic games)
- Greenwald and Hall (Correlated Q-Learning, CQL)
- Jelle and Nikos (Sparse Cooperative Q-Learning)
- Zinkevich (neural network approach for state-space generalisation in MARL)
- Reinaldo et al. (heuristic acceleration of TMAQL)
- Hu et al. (equilibrium transfer)
- Zhang et al. (Q-table dimension reduction in NQL)
- Prof. Surnajan Das (vice-chancellor, Jadavpur University)
- Prof. Chiranjib Bhattacharjee (pro-vice-chancellor, JU)
- Dr. Pradip Kumar Ghosh (pro-vice-chancellor, JU)
- Prof. Sheli Sinha Chaudhuri (HoD, ETCE, JU)
- Khepera II mobile robot (hardware platform used in experiments)
