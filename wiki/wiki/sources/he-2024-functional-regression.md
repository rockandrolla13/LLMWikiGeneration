...
tags: [commodity-futures, functional-regression, state-space-models, schwartz-smith, yield-curves, kalman-filter]
related: [sources/martin-2024-credit-curve, concepts/functional-data-analysis, concepts/schwartz-smith-model, concepts/state-space-models, concepts/kalman-filter, entities/gareth-peters, entities/pavel-shevchenko]
