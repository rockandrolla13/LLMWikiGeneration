...
page_id: entities/robert-goldstein
page_type: entity
related: []
revision_id: 1
sources:
...
**Robert S. Goldstein** is a person (author) appearing in the credit & macro corpus. Affiliation: The Ohio State University (at time of writing).
