...
Investment bank whose published research forms the largest single source cluster
in this wiki: **107 notes spanning 2008 to 2026**. It is the most heavily linked
entity here, and functions less as a company profile than as the front door to
that archive.

## What the Archive Covers

These are sell-side strategy notes, not academic papers. They carry a house view
and a publication date that matters as much as the content.

Coverage follows market stress rather than the calendar. 2019 alone is roughly
half the archive (52 notes), with 2020 next (14) and 2018 after that (11). The
years 2008 to 2015 contribute one or two notes each. That distribution reflects
what was collected, not what was published.

## Recurring Threads

By title, the archive clusters around a few desks:

- **Cross-asset strategy** -- playbooks and monthly recaps, the largest group.
- **Credit** -- investment grade and high yield fundamentals, European credit
  watch, leveraged finance playbooks.
- **Corporate hybrids** -- a primer plus playbooks in 2013, 2014, 2015 and 2019.
- **Rates** -- duration and curves, government bond supply, funding signals.
- **EM and EMFX** -- quantitative quarterlies, risk premia and regime-switching
  indicators.
- **Bank capital** -- AT1 extension and par calls, MREL subordination, CRR2.

## How to Read It

Two cautions.

They are dated market calls, and the archive contains both a call and sometimes
its reversal: compare *Don't Miss the Bull Market* (February 2019) with *Brace
for Recession* (March 2020).

They are also house research produced in a commercial context, which is a
different evidentiary standing from a peer-reviewed paper. Where a claim
matters, trace it to the underlying data rather than resting on the note.

## Entry Points

- [[sources/patkar-2026-ms-global-credit-midyear|Global Credit Webcast, May 2026]] -- most recent
- [[sources/ms-2014-02-21-corporate-hybrid-primer|Corporate Hybrid Primer (2014)]] -- anchor of the hybrids thread
- [[sources/ms-2016-03-22-xccy-basis-primer|Cross-Currency Basis Primer (2016)]]
- [[sources/ms-2018-02-27-who-buys-treasuries|Who Buys Treasuries (2018)]]
- [[sources/ms-2020-03-17-cross-asset-playbook-brace-for-recession|Brace for Recession (March 2020)]]

The full set is in the `sources:` field above. To enumerate by date, grep the
sources directory for `ms-20`.
